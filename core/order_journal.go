...
// the specified pool.
func (journal *orderJournal) load(add func(item *types.OrderItem) error) error {
...
func (journal *orderJournal) insert(tx *types.OrderItem) error {
...
func (journal *orderJournal) rotate(all map[common.Address]types.OrderItems) error {
