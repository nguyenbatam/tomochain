...
func (ms *ManagedState) RemoveNonce(addr common.Hash, n uint64) {
...
func (ms *ManagedState) SetNonce(addr common.Hash, nonce uint64) {
	ms.mu.Lock()
	defer ms.mu.Unlock()
...
func (ms *ManagedState) HasAccount(addr common.Hash) bool {
	ms.mu.RLock()
	defer ms.mu.RUnlock()
...
func (ms *ManagedState) getAccount(addr common.Hash) *exchanges {
