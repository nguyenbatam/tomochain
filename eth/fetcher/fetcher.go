...
type blockInsertFn func(blocks *types.Block) error

type blockPrepareFn func(blocks *types.Block) error
...
func New(getBlock blockRetrievalFn, verifyHeader headerVerifierFn, broadcastBlock blockBroadcasterFn, chainHeight chainHeightFn, insertChain blockInsertFn, prepareBlock blockPrepareFn, dropPeer peerDropFn) *Fetcher {
	...
	again:
		...
		case consensus.ErrNoValidatorSignature:
			...
			if f.appendM2HeaderHook != nil {
				if newBlock, errM2 = f.appendM2HeaderHook(block); errM2 != nil {
