...
// Package masternode implements Ethereum block creation and staking.
package masternode
...
// Backend wraps all methods required for staking.
...
// Staker creates blocks and searches for proof-of-work values.
type Staker struct {
	mux *event.TypeMux
...
// and halt your staking operation for as long as the DOS continues.
...
func (self *Staker) Start(coinbase common.Address) {
	...
	if atomic.LoadInt32(&self.canStart) == 0 {
		log.Info("Network syncing, will start masternode afterwards")
		return
	}
